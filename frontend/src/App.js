...
function Protected({ children, roles }) {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-slate-100"><div className="text-xs uppercase tracking-[0.2em] text-slate-500">Loading…</div></div>;
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<Protected><AppLayout /></Protected>}>
            ...
            <Route path="ceo" element={<Protected roles={["accounts"]}><CEODashboard /></Protected>} />
            ...
            <Route path="audit-log" element={<Protected roles={[]}><AuditLog /></Protected>} />
          </Route>
