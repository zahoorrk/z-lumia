...
import { fmtINR, STATUS_COLOR, statusLabel } from "@/lib/constants";
import {
  TrendUp,
  Money,
  Package,
...
function KPI({ label, value, Icon, accent = "#0F3BE8", sub, testid }) {
  return (
    <div className="lumia-surface p-5 relative overflow-hidden" data-testid={testid}>
      ...
      <div className="mt-3 text-3xl xl:text-4xl font-black tracking-tighter text-slate-900 font-mono-num">
        {value}
      </div>
...
export default function Dashboard() {
  ...
  if (loading || !stats) {
    return (
      <div className="p-6 lg:p-8 space-y-4" data-testid="dashboard-loading">
    ...
    <div className="p-6 lg:p-8 space-y-6" data-testid="dashboard">
      ...
      <div className="flex items-end justify-between flex-wrap gap-3">
        ...
        <div className="text-xs text-slate-500">
          Live snapshot · refreshed just now
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lumia-surface p-5 lg:col-span-4">
          ...
          <h3 className="text-lg font-bold tracking-tight">Project status mix</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
      ...
      <div className="lumia-surface" data-testid="low-stock-section">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold tracking-tight">
                Low stock items{" "}
                <span className="text-[#FF4B00] font-mono-num">
        ...
        {stats.low_stock_items.length === 0 ? (
          <div className="p-8 text-center text-sm text-slate-500">
            All materials are above reorder level. Good signal.
          </div>
        ) : (
          <table className="w-full text-sm">
            <thead>
              <tr className="text-[10px] uppercase tracking-wider text-slate-500 bg-slate-50">
                ...
                <th className="text-right px-5 py-2 font-semibold">Reorder Lvl</th>
            ...
            <tbody>
              {stats.low_stock_items.map((m) => (
                <tr
                  ...
                  data-testid={`low-stock-row-${m.id}`}
                >
                  ...
                  <td className="px-5 py-3 text-right font-mono-num text-[#DC2626] font-semibold">
                    {m.stock_qty} {m.unit}
                  </td>
                  <td className="px-5 py-3 text-right font-mono-num text-slate-500">
                    {m.reorder_level} {m.unit}
                  </td>
                  <td className="px-5 py-3">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider border bg-red-50 text-red-800 border-red-300">
                      Reorder
                    </span>
                  </td>
                </tr>
